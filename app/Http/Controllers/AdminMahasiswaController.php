...
class AdminMahasiswaController extends Controller
{
    public function index(){
        ...
        $pegawai = Pegawai::where('id_pegawai', auth()->user()->id_pegawai)->with('spv')->first();
        $mahasiswa = Mahasiswa::where('nim')->with('spv', 'jurusan', 'univ')->first();
        return view('spv.mahasiswa', compact('univ', 'jurusan', 'mahasiswa', 'pegawai'));
    }

    public function show(){

        $mahasiswa = Mahasiswa::where('id_pegawai', auth()->user()->id_pegawai)->with('univ', 'jurusan')->orderBy('created_at', 'asc')->get();
